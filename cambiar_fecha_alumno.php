...
if(isset($_POST["submit"])){ 
    ...
    if($resultSet3->num_rows>=1){
        ...
        if($conexion->query($actualizar)){                            
            echo "<br>";   
            echo "<div align=\"center\" class=\"alert alert-success\"> Solicitud agregada con éxito, espera una confirmación ENTRE EN EL PRIMERO</div><br>";                                            
            ...
            if($conexion->query($actualizar)){                            
                echo "<br>";   
                echo "<div align=\"center\" class=\"alert alert-success\"> Solicitud agregada con éxito, espera una confirmación ENTRE EN EL SEGUNDO</div><br>";                                
                    //require_once 'inc/header_redireccionamiento.php';               
            }else{
                echo "<br>";
                echo "<div align=\"center\" class=\"alert alert-danger\">Error</div><br>"; 
        ...
        if($conexion->query($actualizar)){                            
            echo "<br>";   
            echo "<div align=\"center\" class=\"alert alert-success\"> Solicitud agregada con éxito, espera una confirmación ENTRE EN EL TERCERO</div><br>";                                
                //require_once 'inc/header_redireccionamiento.php';               
            }else{
            echo "<br>";
            echo "<div align=\"center\" class=\"alert alert-danger\">Error</div><br>"; 
            ...
            if($conexion->query($actualizar)){                            
                echo "<br>";   
                echo "<div align=\"center\" class=\"alert alert-success\"> Solicitud agregada con éxito, espera una confirmación ENTRE EN EL CUARTO</div><br>";                                
                    //require_once 'inc/header_redireccionamiento.php';               
            }else{
                echo "<br>";
                echo "<div align=\"center\" class=\"alert alert-danger\">Error</div><br>"; 

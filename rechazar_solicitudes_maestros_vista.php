...
require_once 'rechazar_maestro.php';
require_once 'comprobar_secretario.php';

$idSolicitud= $_GET["idSolicitud"];
$sql="SELECT idSolicitud, Maestro_idMaestro FROM alumno_has_auditorio WHERE idSolicitud = '$idSolicitud'";
                ...
                <div class="card">
                    <div class ="card-body">
                        <form method="POST">  
                            ...
                            <input type="text" name="Maestro_idMaestro" value = "<?php echo $ver["Maestro_idMaestro"]; ?>" style="visibility:hidden">
                            ...
                            <div class="form-group" >                                
                               ...
                               <!--<label for="caracteres">Carateres utilizado</label><p></p>-->
                                ...
                                <br>
                                <center><a href="autorizar_solicitudes_maestros_vista2.php"><input type="submit" value="Regresar" class="btn btn-lg btn-block btn btn-warning"></a></center>  
                        </form>
                    </div>                    
                </div>
            </div>

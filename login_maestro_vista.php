<?php
require_once 'creacion_sesion_maestro.php';
require_once 'inc/header.php';
require_once 'inc/banner.php';
require_once 'db/database.php';
require_once 'login_maestro.php';
?>
    ...
    <div class = "container">
        <div class = "row justify-content-center">
            <div class="col col-md-6">
                <div class="card">
                    <div class ="card-body">
                        <h2 class="h2"><center>MAESTRO</center></h2>
                        <form method="POST">
                            <div class="form-group">
                                ...
                                pattern="^([P][0-9]{8})$" required placeholder="Ingresa número de control, 'P' seguida de 8 dígitos. Ej. P12345678"
                                maxlength="9"
                                class="form-control"
                                >
                            </div>
